...
const Button = forwardRef(({
  ...
  const baseClasses = 'relative inline-flex items-center justify-center box-border rounded-full font-medium tracking-[0.1px] transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 overflow-hidden select-none';
  
  // Using custom M3 colors defined in tailwind.config.cjs
  const variantClasses = {
    filled: 'bg-m3-primary text-white hover:bg-[#8A0027] hover:shadow-m3-sm active:bg-[#720020] active:shadow-none focus-visible:ring-m3-primary',
    outlined: 'border border-m3-outline text-m3-primary bg-transparent hover:bg-m3-primary/10 hover:border-m3-primary active:bg-m3-primary/20 focus-visible:ring-m3-primary',
    text: 'bg-transparent text-m3-primary hover:bg-m3-primary/10 active:bg-m3-primary/20 focus-visible:ring-m3-primary',
    elevated: 'bg-m3-surface text-m3-primary shadow-m3-sm hover:shadow-m3-md hover:bg-white active:bg-m3-surface/80 active:shadow-m3-sm focus-visible:ring-m3-primary',
    tonal: 'bg-m3-primary-container text-[#3A000D] hover:bg-m3-primary-container/80 hover:shadow-m3-sm active:bg-m3-primary-container/60 active:shadow-none focus-visible:ring-m3-primary',
  };
