...
const WhatsAppFAB = () => {
  ...
  const text = encodeURIComponent('Hola Big Planners, vengo de su sitio web y me gustaría recibir información.');
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1EBE5A] text-white p-4 rounded-full shadow-m3-lg hover:shadow-m3-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group"
