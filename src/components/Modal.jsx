...
const Modal = ({ isOpen, onClose, packageData }) => {
  ...
  const message = encodeURIComponent(`Hola Big Planners, vengo de su sitio web y me gustaría recibir información sobre el paquete a ${packageData.title}.`);
      ...
      <div className="relative bg-m3-surface rounded-m3 shadow-m3-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto flex flex-col transform transition-all">
        ...
        <div className="p-8 flex flex-col gap-6">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="font-heading text-3xl font-bold text-gray-900 mb-2">{packageData.title}</h2>
            ...
            <div className="text-right">
              <p className="font-body text-sm text-gray-500 uppercase tracking-wide">Desde</p>
              <p className="font-heading text-2xl font-bold text-m3-primary">{packageData.price}</p>
            </div>
          </div>

          <div className="border-t border-gray-200 pt-6">
            <h3 className="font-heading text-xl font-semibold mb-3">¿Qué incluye?</h3>
