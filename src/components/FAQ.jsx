    ...
    <section id="faq" className="py-24 bg-m3-surface">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <ScrollReveal key={faq.id} animation="fade-up" delay={index * 100}>
              <div className="bg-white rounded-lg shadow-m3-sm overflow-hidden transition-all duration-300 border border-m3-outline/10">
                <button
